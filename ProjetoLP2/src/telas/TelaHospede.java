...
public class TelaHospede extends JInternalFrame {
	/**
	 * 
	 */
	...
	public TelaHospede() {
		...
		JButton btnFichaDeHospedes = new JButton("Ficha de Hospedes");
